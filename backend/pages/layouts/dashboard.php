				...
				<div class="daily-feeds card">
					...
					<div class="card-body no-padding">
						...
						<div class="item">
							<div class="feed d-flex justify-content-between">
								<div class="feed-body d-flex justify-content-between">
									<a href="#" class="feed-profile"><img src="assets/img/avatar-5.jpg" alt="person" class="img-fluid rounded-circle" /></a>
									<div class="content">
										<h5>Aria Smith</h5>
						...
						<div class="item">
							<div class="feed d-flex justify-content-between">
								<div class="feed-body d-flex justify-content-between">
									<a href="#" class="feed-profile"><img src="assets/img/avatar-2.jpg" alt="person" class="img-fluid rounded-circle" /></a>
									<div class="content">
										...
										<div class="CTAs">
											<a href="#" class="btn btn-xs btn-secondary"><i class="fa fa-thumbs-up"> </i>Like</a><a href="#" class="btn btn-xs btn-secondary"><i class="fa fa-heart"> </i>Love
											</a>
										</div>
									</div>
								</div>
						...
						<div class="item clearfix">
							<div class="feed d-flex justify-content-between">
								<div class="feed-body d-flex justify-content-between">
									<a href="#" class="feed-profile"><img src="assets/img/avatar-3.jpg" alt="person" class="img-fluid rounded-circle" /></a>
									<div class="content">
										<h5>Ashley Wood</h5>
										<span>Posted a new blog </span>
										<div class="full-date">
							...
							<div class="CTAs pull-right">
								<a href="#" class="btn btn-xs btn-secondary"><i class="fa fa-thumbs-up"> </i>Like</a>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="item">
							<div class="row">
								<div class="col-4 date-holder text-right">
									...
									<div class="date">
										<span>6:00 am</span><br /><span class="text-info">6 hours ago</span>
									</div>
								</div>
